...
class Complejo(object):
    ...
    def multiplicar(self, otro):
        result = Complejo(self.real*otro.real-self.imag*otro.imag,self.real*self.otro+self.imag*otro.real)
        return result
...
#assertequal = es verdad que...
    ...
    def test_multiplicar(self):
        ...
        self.assertEqual(multiplicar.real, 42)
    ...
    def test_dividir(self):
        ...
        self.assertEqual(dividir.real, 0.65)
        self.assertEqual(dividir.imag, -0.2)
